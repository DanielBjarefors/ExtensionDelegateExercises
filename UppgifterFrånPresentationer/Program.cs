...
namespace UppgifterFrånPresentationer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var loopInstance = new Loop();
            var printInstance = new Print();

            eventInstance.firstEvent += loopInstance.LoopMethod;    //subscribe to an event 
            loopInstance.secondEvent += printInstance.PrintMethod;   //subscribe to an event 
            eventInstance.Interval();    // publisher 
